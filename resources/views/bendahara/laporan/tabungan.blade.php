...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    <h5 class="txt-dark">Laporan Tabungan</h5>
</div>
<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
    <ol class="breadcrumb">
        <li><a href="/">Bendahara</a></li>
        <li class="active"><span>Laporan Tabungan</span></li>
    </ol>
</div>
@endsection
@section('content')
            ...
            <div class="panel-wrapper collapse in">
                <form method="POST" class="panel-body">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        @if (!empty($tglAwal))
                        <a target="_blank" href="{{ route('lap.tabungan.cetak', [$tglAwal, $tglAkhir]) }}" class="btn btn-danger">Cetak</a>
                        @endif
                    </div>
                </form>
            </div>
